...
const Work = () => {
  return (
		<div className=' '>
			...
			>
				<motion.div variants={scrollAnim}  className='text-center md:text-start font-sans p-6 flex flex-col items-center justify-center lg:items-start space-y-8 max-w-[1440px] mx-auto'>
